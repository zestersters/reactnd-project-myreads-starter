...
class BooksApp extends React.Component {
        ...
        return (
            <div className="app">
                ...
                */}
                                ...
                                {queryResults.map(book =><Book book={book} onChange={this.onChange}/>)}
                                ...
                                <div className="bookshelf">
                                    ...
                                    <div className="bookshelf-books">
                                        <ol className="books-grid">
                                            ...
                                            ).map(current => <li key={current.title}><Book book={current}
    ...
    getNewQuery = (e) => {
        ...
        if(e.target.value !== '')
        search(e.target.value).then(value => this.setState(console.log(value)))
    }
    onChange = (e, bookTitle) => {
        const {books} = this.state
      for(let book of Object.keys(books)) {
          if(books[book].title === bookTitle) books[book].status = e.target.value
      }
